    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Торти", "Торти на любий смак і вагу" },
                    { 2, "Кекси", "Смачне печиво для вас" }
                });

            migrationBuilder.InsertData(
                table: "Desserts",
                columns: new[] { "DessertId", "CategoryId", "Description", "ImageUrl", "IsAvailable", "Name", "Price" },
                values: new object[,]
                {
                    { 1, 1, "Смачний шоколадний торт із кремом", "/img/cacao-tortyk.jpg", true, "Шоколадний торт", 250 },
                    { 2, 2, "Ніжний кекс із ванільним смаком", "/img/keksi_vanyl.jpg", true, "Ванільний кекс", 50 },
                    { 3, 1, "Класичний сирний чізкейк", "/img/chees_cake.jpg", true, "Чізкейк", 200 }
                });
